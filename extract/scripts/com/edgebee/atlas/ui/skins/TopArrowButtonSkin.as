package com.edgebee.atlas.ui.skins
{
   ...
   public class TopArrowButtonSkin extends CustomizableButtonSkin
   {
       
      
      public function TopArrowButtonSkin(param1:Component)
      {
         super(param1);
         width = height = 16;
      }
      ...
      override protected function drawContent() : void
      {
         ...
         _customShape.graphics.moveTo(_loc2_,component.height - _loc5_);
         _customShape.graphics.lineTo(component.width / 2,_loc4_);
         _customShape.graphics.lineTo(component.width - _loc3_,component.height - _loc5_);
         _customShape.graphics.lineTo(_loc2_,component.height - _loc5_);
