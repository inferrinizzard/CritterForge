package com.edgebee.atlas.ui.skins
{
   ...
   public class LeftArrowButtonSkin extends CustomizableButtonSkin
   {
       
      
      public function LeftArrowButtonSkin(param1:Component)
      {
         super(param1);
      }
      ...
      override protected function drawContent() : void
      {
         ...
         _customShape.graphics.lineStyle(2,_loc1_,1,true);
         _customShape.graphics.moveTo(_loc2_,component.height / 2);
         ...
         _customShape.graphics.lineTo(_loc2_,component.height / 2);
