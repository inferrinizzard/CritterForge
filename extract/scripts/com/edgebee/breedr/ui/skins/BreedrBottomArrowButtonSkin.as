package com.edgebee.breedr.ui.skins
{
   ...
   public class BreedrBottomArrowButtonSkin extends BreedrButtonSkin
   {
       
      
      private var _content:Canvas;
      
      public function BreedrBottomArrowButtonSkin(param1:Component)
      {
         super(param1);
      }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         this._content.graphics.moveTo(-3,0);
         this._content.graphics.lineTo(3,6);
         this._content.graphics.lineTo(9,0);
